...
v17:
* Improving the "pattern", "minLength", and "maxLength" descriptions
  in "stringType".
* Improving the "reference" description in "stringType": Changing "URI" to "URL"
...
* Setting all "additionalProperties" to false for every defined object.
